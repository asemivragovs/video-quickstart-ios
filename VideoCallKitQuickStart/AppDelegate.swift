...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication,
        ...
        TwilioVideoSDK.setLogLevel(.all, module: .core)
        TwilioVideoSDK.setLogLevel(.all, module: .platform)
        TwilioVideoSDK.setLogLevel(.all, module: .signaling)
        TwilioVideoSDK.setLogLevel(.all, module: .webRTC)
